...
namespace GLBase
{
                                    ...
                                    unsigned int& indexShadow)
    {
        ...
        lightingShader.setFloat("spotLights[" + std::to_string(indexSpot) + "].radiusMax", mCosAngleInner);
        lightingShader.setFloat("pointLights[" + std::to_string(indexSpot) + "].radiusMax", mRadiusMax);
