...
Shader::Shader(const std::string &vertexPath, const std::string &fragmentPath,
               const std::string &geometryPath, const std::string &tessCtrlPath,
    ...
    // The second argument specifies how many string of source code we are
    // passing.
    ...
    // Once the shaders are linked in the program, we don't need the shader
    // objects.
...
void Shader::setFloat4(const std::string &name, float value1, float value2,
