...
public:
    ...
    friend void applicationFramebufferSizeCallback(GLFWwindow *window,
                                                   int width, int height);
    friend void applicationMouseCallback(GLFWwindow *window, double xpos,
                                         double ypos);
    friend void applicationScrollCallback(GLFWwindow *window, double xoffset,
                                          double yoffset);
