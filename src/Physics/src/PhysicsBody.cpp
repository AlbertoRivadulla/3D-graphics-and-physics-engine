...
CollisionBody::CollisionBody(glm::vec3 position, glm::vec3 scale,
    ...
    if (rotationAngle != 0.)
        mRotationMatrix =
            glm::rotate(mRotationMatrix, glm::radians(rotationAngle),
...
// Add material
void CollisionBody::addMaterial(Material *material) { mMaterial = material; }
...
// Getters
glm::vec3 CollisionBody::getPosition() { return mPosition; }
...
// Constructor
RigidBody::RigidBody(glm::vec3 position, glm::vec3 scale, float rotationAngle,
